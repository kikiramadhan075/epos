...
mixin _$SummaryState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(int total) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(int total)? success,
...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl(this.total);
  ...
  @override
  String toString() {
    return 'SummaryState.success(total: $total)';
  }
...
abstract class _Success implements SummaryState {
  const factory _Success(final int total) = _$SuccessImpl;
